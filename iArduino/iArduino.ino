...
byte mac[] = { 0x90, 0xA2, 0xDA, 0x0D, 0x9C, 0x35 };  //Set your Ethernet Shield's MAC address here - make sure you replace the MAC Address with your shield's values!
byte ip[] = { 192,168,1,97 };                        // Set your shield's desired IP address here - check your network for configuration details
