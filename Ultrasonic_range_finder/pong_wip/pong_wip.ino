...
#include <Adafruit_GFX.h>
 // use Esplora library function

// SPI pins for Esplora (Arduino Leonardo style numbering)
#define mosi 5      //changed
//#define miso 3
#define sclk 4      //changed
#define cs    6     //changed
#define dc    7     //changed
#define rst   8     //changed

Adafruit_ST7735 tft = Adafruit_ST7735(cs, dc, mosi, sclk, rst);  // define tft display (use Adafruit library) hw (if you add osi and sclk it will slow too much)
...
void setup(){
  ...
  tft.println("");
  tft.println("   UNO port by:");
  tft.println("           Matt Booker");
  tft.setTextColor(ST7735_WHITE, ST7735_BLACK);
  tft.println(" ");
  tft.println(" Press Switch 4 To Start");
  while(switchPin==LOW) ;                                    // New game when swtich 4 is pressed
  delay(2000);
